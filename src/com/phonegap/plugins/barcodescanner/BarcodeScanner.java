...
import com.symbol.scanning.ScanDataCollection.LabelType;
...
public class BarcodeScanner extends CordovaPlugin  {
	...
	public void setRetData(String data) {
		if(data!="") {
	       	 JSONObject obj = new JSONObject();
	            try {
	                obj.put(TEXT, data);
	                obj.put(FORMAT, "EAN_13");
    ...
    public void scan(JSONArray args) {
    	...
    	//{"cancelled":false,"text":"9787115281586","format":"EAN_13"}
