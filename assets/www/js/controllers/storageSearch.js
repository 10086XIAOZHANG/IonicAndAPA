define(['app','../service/storageService.js','../service/userStorage.js','../service/storeInformation.js','../service/authenticate.js','../service/httpGetData.js'],function (app) {
  app.controller('storageSearchCtrl', ['$scope', '$stateParams','$state','$ionicHistory','storageFactory','userFactory','storeInformationFactory','authenticateFactory','dataFactory', function($scope, $stateParams,$state,$ionicHistory,storageFactory,userFactory,storeInformationFactory,authenticateFactory,dataFactory) {
    // $scope.tag = "";
    //
